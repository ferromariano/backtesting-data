...
class api_bingx_spot(object):
    ...
    def klines(self, symbol: str, interval: str, **kwargs):
        ...
        :API doc: https://bingx-api.github.io/docs/#/en-us/spot/market-api.html#Kline/Candlestick%20Data
        ...
        return self.query("/openApi/spot/v2/market/kline", params)
...
class bingx_spot(exchange_data):
    ...
    def __init__(self, cache_path=None, cache_type=None):
        ...
        self._cache_path_exchange = 'bingx_spot'
        self.public_name:str=self._cache_path_exchange
        self._api = api_bingx_spot()
